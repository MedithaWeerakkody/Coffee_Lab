  ...
  Future<void> addRealMenuItems() async {
    final realMenuItems = [
      ...
      MenuItem(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1545665277-5937750a7c1b?w=800&q=80',
        category: 'Coffee',
      ),
      MenuItem(
        id: '',
      ...
      MenuItem(
        ...
        name: 'Mocha',
        price: 4.50,
        description: 'Chocolate espresso drink with steamed milk and whipped cream',
      ...
      MenuItem(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1517701550184-7e6a3eb56503?w=800&q=80',
        category: 'Coffee',
      ),
      MenuItem(
        id: '',
        name: 'Iced Latte',
        price: 4.25,
        description: 'Chilled espresso with cold milk and ice, perfectly refreshing',
      ...
      MenuItem(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1555507036-ab794f575db6?w=800&q=80',
        category: 'Pastry',
      ),
      MenuItem(
        id: '',
      ...
      MenuItem(
        ...
        name: 'Avocado Toast',
        price: 6.50,
        description: 'Sourdough bread topped with smashed avocado, lime, and sea salt',
      ...
      MenuItem(
        ...
        price: 9.50,
        description: 'Quinoa, feta, olives, cucumber, tomatoes with lemon vinaigrette',
      ...
      MenuItem(
        ...
        price: 10.50,
        description: 'Mixed greens with grilled chicken, cherry tomatoes, and balsamic',
      ...
      MenuItem(
        ...
        name: 'Caprese Salad',
        price: 7.50,
        description: 'Fresh mozzarella, tomatoes, basil with olive oil and balsamic',
      ...
      MenuItem(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?w=800&q=80',
        category: 'Sandwich',
      ),
      MenuItem(
        id: '',
      ...
      MenuItem(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=800&q=80',
        category: 'Sandwich',
      ),
